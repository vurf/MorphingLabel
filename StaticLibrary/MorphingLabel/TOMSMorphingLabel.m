 ...
 */
@interface MorphingLabelWeakWrapper : NSObject
@property (nonatomic, weak, readonly) MorphingLabel *morphingLabel;

- (instancetype)initWithLabel:(MorphingLabel *)label;

@end

@interface MorphingLabel (){
...
{
    MorphingLabelWeakWrapper *displayLinkTarget = [[MorphingLabelWeakWrapper alloc] initWithLabel:self];
...
@implementation MorphingLabelWeakWrapper
